...
import com.example.desertclicker.ui.DesertUiState
import com.example.desertclicker.ui.DesertViewModel
...
@Composable
fun DessertClickerApp(viewModel: DesertViewModel= viewModel()) {
    val uiState by viewModel.uiState.collectAsState()
    DessertClickerApp(uiState=uiState, onDessertClicked = viewModel::onDesertClicked)
}

@Composable
fun DessertClickerApp(uiState: DesertUiState,onDessertClicked: () -> Unit,modifier: Modifier=Modifier) {
        ...
        DessertClickerAppBar(
            onShareButtonClicked = {
                shareSoldDessertsInformation(
                    ...
                    dessertsSold = uiState.desertSold,
    ...
    Box(modifier) {
        ...
        Column {
            Box(
                ...
                Image(painter = painterResource(id = dessertImageId),
